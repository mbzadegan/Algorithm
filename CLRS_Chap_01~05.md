...
* **Iterated Logarithm:** The number of times the logarithm function must be applied to $n$ before the result is $\le 1$. It grows extremely slowly (e.g., $\lg^* 2^{65536} = 5$).
